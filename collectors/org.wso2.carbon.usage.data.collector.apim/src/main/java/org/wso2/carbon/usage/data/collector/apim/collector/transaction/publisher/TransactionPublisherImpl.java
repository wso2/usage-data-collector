...
package org.wso2.carbon.usage.data.collector.apim.collector.transaction.publisher;
...
/**
 * Transaction Report Publisher implementation for APIM.
 */
@Component(
    name = "org.wso2.carbon.usage.data.collector.apim.transaction.reporter",
...
public class TransactionPublisherImpl implements TransactionPublisher {
    ...
    protected void activate() {
        org.wso2.carbon.usage.data.collector.apim.collector.transaction.counter.TransactionCountHandler.registerTransactionPublisher(
                this);
    }

    @Deactivate
    protected void deactivate() {
        org.wso2.carbon.usage.data.collector.apim.collector.transaction.counter.TransactionCountHandler.unregisterTransactionPublisher(
                this);
    }
    ...
    public void startReporting() {
        ...
        aggregator = TransactionAggregator.getInstance();
        if (aggregator == null) {
    ...
    public boolean reportNow() {
        ...
        try {
            ...
            TransactionReport report = new TransactionReport(count, hourStartTime, hourEndTime);
